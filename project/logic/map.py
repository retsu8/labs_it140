    ...
    def __init__(self):
        self.location = {
            ...
            "lab": {
                ...
                "item": "green_slime",
                "room_image": "",
                "connected_rooms": {"west":"meeting_room", "east":"start_room", "south":"kitchen"} 
            },
            "meeting_room": {
                "name": "Meeting Room",
                ...
                "item": "research_notes",
                "room_image": "",
                "connected_rooms": {"east":"lab", "north":"kiras_room", "west":"bruces_room", "south":"koals_room"}
            },
            "kiras_room": {
                "name": "Kira's Room",
            ...
            "staff_quarters": {
                ...
                "item": "sandwich",
                "room_image": "",
                "connected_rooms": {"north":"kitchen", "west":"armory", "east":"garage"}
            },
            "lounge": {
                "name": "Lounge",
            ...
            "kitchen": {
                ...
                "item": "vehicle_keys",
                "room_image": "",
                "connected_rooms": {"north":"lab", "east":"lounge", "south":"staff_quarters"}
            },
            "garage": {
                "name": "Garage",
